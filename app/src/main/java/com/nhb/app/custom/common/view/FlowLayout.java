...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            horizontalSpacing = a.getDimensionPixelOffset(R.styleable.FlowLayout_horizontalSpacing, 0);
            verticalSpacing = a.getDimensionPixelOffset(R.styleable.FlowLayout_verticalSpacing, 0);
    ...
    public void notifyChange() {
        ...
        //modify at 4.0 in 2015-02-14 by Michael，bugfix
        removeAllViews();
        if (mAdapter != null) {
            for (int i = 0; i < mAdapter.getCount(); i++) {
                final int index = i;
                final View v = mAdapter.getView(i, null, FlowLayout.this);
                v.setOnClickListener(new OnClickListener() {

                    @Override
                    public void onClick(View v) {
                        if (mOnItemClickListener != null) {
                            mOnItemClickListener.onItemClick(FlowLayout.this, v, index, mAdapter.getItem(index));
                        }
                    }
                });
                addView(v);
