 ...
 * ***********************************************************************
 * Author:pengxiaofang
 * CreateData:2016-11-09 20:27
 * Version:xx
 * Description:启动页广告加载转圈动画
 * ***********************************************************************
 */
public class DonutProgress extends View {
    ...
    private final int default_finished_color = getResources().getColor(R.color.c_99000000);
    private final int default_unfinished_color = getResources().getColor(R.color.c_main);
    private final int default_text_color = getResources().getColor(R.color.white);
    private final int default_inner_bottom_text_color = getResources().getColor(R.color.white);
    private final int default_inner_background_color = getResources().getColor(R.color.c_99000000);
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DeviceUtils.dip2px(13);
        min_size = DeviceUtils.dip2px(100);
        default_stroke_width = DeviceUtils.dip2px(10);
        default_inner_bottom_text_size = DeviceUtils.dip2px(13);
