...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    //存储条目类型
    private SparseArray<Integer> layoutArray = null;
    ...
    protected void addItemType(int type,int layoutResId){
        ...
        layoutArray.put(type,layoutResId);
    }

    protected void addItemType(int layoutResId){
    ...
    public int getItemLayoutId(int viewType){
        if (layoutArray == null){
            throw new RuntimeException("请先调用addItemType()");
        }
        return layoutArray.get(viewType);
    }
