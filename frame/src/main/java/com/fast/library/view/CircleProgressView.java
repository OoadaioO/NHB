...
public class CircleProgressView extends View{
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (isInEditMode()){
            mColors = new int[4];
            mColors[0] = getResources().getColor(R.color.FastLib_circular_blue,null);
            mColors[1] = getResources().getColor(R.color.FastLib_circular_green,null);
            mColors[2] = getResources().getColor(R.color.FastLib_circular_red,null);
            mColors[3] = getResources().getColor(R.color.FastLib_circular_yellow,null);
        }else {
